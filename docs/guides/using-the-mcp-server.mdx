...
The Reactive Resume MCP server lets you manage and modify your resumes through any MCP-compatible AI tool - Claude Desktop, Cursor, Codex, and more. It connects to the Reactive Resume API and exposes resume-focused tools using natural language.
