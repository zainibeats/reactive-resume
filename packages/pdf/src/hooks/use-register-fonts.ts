...
export const registerFonts = (
	...
	for (const italic of [false, true]) {
		...
		// The mainEntryBold slot resolves to max(700, heaviest authored weight); 700 is registered
		// unconditionally so that face always exists, and anything heavier is bodyRange.highest above.
